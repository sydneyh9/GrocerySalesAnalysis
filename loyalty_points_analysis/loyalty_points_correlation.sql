...
SUM(final_amount) AS total_revenue, SUM(loyalty_points) AS total_points_issued, SUM(loyalty_points) * 1.0/SUM(final_amount) AS points_per_dollar,
SUM(final_amount) * 1.0/SUM(quantity) AS avg_unit_price
